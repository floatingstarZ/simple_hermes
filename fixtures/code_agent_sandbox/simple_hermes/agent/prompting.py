...
def build_planner_prompt(ctx: PromptContext) -> str:
    payload = {
        ...
        "rules": [
            ...
            "For coding tasks, inspect the project first with tree, glob, search, read, or read_lines before editing.",
            ...
            "If the user asks for a code change, do not run tests until a write_file, patch_file, or terminal edit has succeeded.",
            ...
            "After editing code, run a relevant test command before claiming completion if the user asked to verify or complete a coding task.",
